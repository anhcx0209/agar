 ...
 */
public class PetriDish extends Sprite {
    private static final Logger logger = Logger.getLogger(PetriDish.class.getName());
    ...
    public PetriDish(int size, boolean isBot, boolean isAllied) {
        this.size = size; 
        this.isBot = isBot; 
