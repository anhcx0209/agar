 ...
 * @author tuyenhuynh
 */
public class GamePlay extends engine.GameObject {
    ...
    private final Color[] colors = new Color[]{Color.BLUE, Color.GREEN, Color.GRAY, 
    ...
    private PetriDish playerSprite, AlliedSprite; 
    ...
    public GamePlay(engine.GameEngine gameEngine, boolean allies) {
        super(gameEngine); 
        this.random = new Random();
        this.timer = new Timer(AGAR_GEN_INTERVAL);
        this.allies=allies;
    }
    ...
    public void initResources() {
        try{
            ...
            playerSprite = new PetriDish(100, false,false); 
            ...
            if (allies){
                AlliedSprite = new PetriDish(100, false,true); 
    ...
    private boolean isOverlapped(engine.Sprite s1, engine.Sprite s2) {
        int gap = 20;
    ...
    private boolean addNewBot(BufferedImage botImage, Point position){
        PetriDish botSprite = new PetriDish(botImage.getHeight(), true,false);
...
//        Graphics2D new2D = new Graphics2D(gd);
//        renderInContext(new2D);
